...
export const Header: React.FC<HeaderProps> = ({ userName }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-brown/95 backdrop-blur-sm text-white shadow-lg z-50 flex items-center justify-between px-4 transition-all duration-300">
      {/* Left: Server Info */}
      ...
      {/* Center: Title */}
      <h1 className="text-lg font-bold tracking-tight text-white/90">{t('appTitle')}</h1>
